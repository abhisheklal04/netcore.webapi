...
",
    ...
    public class ErrorHandlingMiddleware
    {
        ...
        private static Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            Console.WriteLine((exception.Source == nameof(CustomerApi) ? "App Error - " : "Unhandled Error - ") + exception.GetType().Name + ": " + exception.Message);
            _logger.LogError((exception.Source == nameof(CustomerApi) ? "App Error - " : "Unhandled Error - ") + exception.GetType().Name + ": " + exception.Message);
            Console.ResetColor();
            if (exception.Source != nameof(CustomerApi))
            {
